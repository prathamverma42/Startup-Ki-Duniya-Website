...
const Carouselelem = [
    ...
    <ol className="h4 font-weight-light">
        ...
        <li>Check your Application Status in whichever companies you have applied for.</li>
...
const Home = ()=>{
    ...
    return (
        ...
        <h2> Or</h2>
        <h3 className = "font-weight-light">Are you looking for Potential Candidates for your startup?</h3>
        <h3 className="my-3">We can help...</h3>

        <p className="h3 py-5">Startup ki Duniya is a Portal which aims to provide a platform for both 
        candidates or people with startup Ideas. Candidates who are looking a suitable
        startup to work upon or people who have a well established sartup and are 
        looking for potential candidates for themselves can use this portal</p>    
        </div>
